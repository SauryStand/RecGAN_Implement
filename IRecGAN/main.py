...
from evaluate import evaluate_interaction, evaluate_discriminator, evaluate_agent, evaluate_user
...
if __name__ == '__main__':
    ...
    #Routes
    pretrained_gen =  'output/irecGan_gen3.simu.model.pth'
    pretrained_dis =  'output/irecGan_dis.simu.model.pth'
    pretrained_agent = 'output/irecGan_agent3.simu.model.pth'
    final_dis = 'output/irecGan_dis1.model.simu.pth'
    ...
    subprocess_cmd = "python ../main/generate_data.py --load --embed_dim 50 --nhid 20 --embed_dim_policy 20 --nhid_policy 20"
    ...
    for e in range(Epochs):
        ...
        torch.save(agent, 'output/agent.pickle')
         
        if interact: 
        #Generate new samples from the environment
            reward_orig, reward_optim = Eval('output/agent.pickle')
            if e == 0:
